...
folder_path = r'C:\Users\gkp\OneDrive - Oak Ridge National Laboratory\0_mK STM DATA\2023\0507 FeTe0.55Se0.45_new_batch1_PtIrTip3_mK_start_Jewook'
...
#gwy_xr_f = filter_diffofgaussians_xr(gwy_xr,low_sigma= 10,high_sigma=None,overwrite= True)
gwy_xr_f = filter_diffofgaussians_xr(gwy_xr,low_sigma= None,high_sigma=10,overwrite= True)
