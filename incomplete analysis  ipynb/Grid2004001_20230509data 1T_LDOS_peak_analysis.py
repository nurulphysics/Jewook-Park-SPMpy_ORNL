...
grid_LDOS_rot_sg = savgolFilter_xr(grid_LDOS_rot, window_length =11, polyorder = 5)
...
grid_LDOS_rot_sg_1deriv_sg = savgolFilter_xr(grid_LDOS_rot_sg_1deriv, window_length = 11, polyorder = 5)
grid_LDOS_rot_sg_2deriv = grid_LDOS_rot_sg_1deriv_sg.differentiate('bias_mV')
grid_LDOS_rot_sg_2deriv_sg =  savgolFilter_xr(grid_LDOS_rot_sg_2deriv, window_length = 11, polyorder = 5)
...
# +
grid_LDOS_zm = grid_LDOS.where( (grid_LDOS.X >0E-7)&(grid_LDOS.X <0.5E-7)&(grid_LDOS.Y >0.0E-7) &(grid_LDOS.Y <0.5E-7), drop = True)
