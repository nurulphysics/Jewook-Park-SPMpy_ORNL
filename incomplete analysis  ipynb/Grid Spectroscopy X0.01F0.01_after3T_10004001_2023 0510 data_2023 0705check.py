...
crrltn_pk_idx = sp.signal.argrelextrema(crrlt2D_topo_LDOS.correlation2D.to_numpy(), np.greater, order = 5)
crrltn_dp_idx = sp.signal.argrelextrema(crrlt2D_topo_LDOS.correlation2D.to_numpy(), np.less, order = 5)
# order: range.. 
...
sns.lineplot (x = 'bias_mV', y= 'LDOS_fb', 
              data = grid_LDOS_th.LDOS_fb.where(grid_LDOS_th.LDOS_fb_th_label ==1 ).mean(['X','Y']).to_dataframe(),
              ax =ax, label = '1')
"""
sns.lineplot (x = 'bias_mV', y= 'LDOS_fb', 
