...
grid_LDOS_fft_log_rot  = rotate_3D_xr( grid_LDOS_fft_log , rotation_angle=11 )

grid_LDOS_fft_log_rot.LDOS_fb_fft.sel(freq_X = 0, method = "nearest").plot()

#grid_LDOS_fft_log.LDOS_fb_fft.sel(freq_X = 0, method = "nearest").plot()
#hv_bias_mV_slicing(grid_LDOS_fft_log, ch = 'LDOS_fb_fft',frame_width=400)
