...
#
# ## <font color= red > Magnetic field 0.1 T (Z)   </font>
# -
...
# line data
grid_xr = grid2xr(files_df[files_df.type=='3ds'].file_name.iloc[14])
grid_xr
...
grid_LDOS_sg = savgolFilter_xr(grid_LDOS, window_length = 21, polyorder = 3)
...
hv_bias_mV_slicing(grid_LDOS, ch = 'LDOS_fb',frame_width=300).opts(clim = (2E-9,3E-9)) # adjust cbar limit
...
bias_mV_slices = np.arange(-2.4,2.5,0.4)
