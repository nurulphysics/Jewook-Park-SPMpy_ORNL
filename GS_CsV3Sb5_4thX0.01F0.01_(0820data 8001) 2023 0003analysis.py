...
# * 2023 0814
#
# ## **Sample** :<font color= White, font size="5" >  $CsV_{3}Sb_{5}, 4^{th} crystal $ 82K cleaving </font> 
...
# ## Measurement temp: mK ( $/approx$ 700 mK), during 4He recovery
#
...
# line data
grid_xr = grid2xr(files_df[files_df.type=='3ds'].file_name.iloc[5])
grid_xr
...
bias_mV_slices = np.arange(-5.0,5.1, 0.5)
