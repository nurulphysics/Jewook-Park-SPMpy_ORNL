...
ax.legend(handles2,   labels2, title = legend_title,loc='upper right', bbox_to_anchor=(1.3, 1))
...
ax.annotate(SCgaps, xy=(text_x, text_y), xytext=(text_x, text_y ),
            ...
            bbox=bbox_props, arrowprops=dict(facecolor='white', arrowstyle='-'))
...
# #### add max peak detection & calc rotation angle based on FFT 
#
# ### add markers for square lattice 
#
#
# ### add lattice constant for FeTeSe 
#
#
...
bound_box_fft = hv.streams.BoundsXY(source = bbox_points,
                                bounds=(0,0,0,0))
#dmap.opts(clim = (0,1E-12))*bbox_points
dmap*bbox_points
