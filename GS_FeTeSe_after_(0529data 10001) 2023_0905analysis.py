...
rec_in_topo_bb1 =  patches.Rectangle( rec_xy_bb1 , rec_w_px_bb1,rec_h_px_bb1 , linewidth=1, edgecolor= sns.color_palette('Paired')[0], facecolor='none')
rec_in_topo_bb2 =  patches.Rectangle( rec_xy_bb2 , rec_w_px_bb2,rec_h_px_bb2 , linewidth=1, edgecolor=sns.color_palette('Paired')[1], facecolor='none')

rec_in_topo_bb3 =  patches.Rectangle( rec_xy_bb3 , rec_w_px_bb3,rec_h_px_bb3 , linewidth=1, edgecolor=sns.color_palette('Paired')[2], facecolor='none')
rec_in_topo_bb4 =  patches.Rectangle( rec_xy_bb4 , rec_w_px_bb4,rec_h_px_bb4 , linewidth=1, edgecolor=sns.color_palette('Paired')[3], facecolor='none')
...
#bias_mV_slices = np.arange(-3.2,3.21,0.2)
bias_mV_slices = np.arange(-1.0,1.1, 0.2)
...
grid_LDOS_df = grid_LDOS.where(abs(grid_LDOS.bias_mV)<1.2,drop = True) .to_dataframe().unstack()
