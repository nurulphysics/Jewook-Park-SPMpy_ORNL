...
#
# ## <font color= red > Magnetic field 0.02 T (Z)   </font>
# -
...
# line data
grid_xr = grid2xr(files_df[files_df.type=='3ds'].file_name.iloc[3])
grid_xr
...
hv_bias_mV_slicing(grid_LDOS, ch = 'LDOS_fb',frame_width=300).opts(clim = (0.0E-9,1E-9)) # adjust cbar limit
...
bbox_1, _ = hv_bbox_avg(grid_LDOS, bound_box= bound_box, ch ='LDOS_fb',slicing_bias_mV = 0.4)
...
# Choose peak labels
###############
grid_LDOS_bbox_pk_df_choose = grid_LDOS_bbox_pk_df [(grid_LDOS_bbox_pk_df.y_kmeans  ==2)
