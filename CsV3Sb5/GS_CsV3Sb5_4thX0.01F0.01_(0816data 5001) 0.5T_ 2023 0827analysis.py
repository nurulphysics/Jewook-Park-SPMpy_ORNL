...
# line data
grid_xr = grid2xr(files_df[files_df.type=='3ds'].file_name.iloc[15])
grid_xr
...
hv_bias_mV_slicing(grid_LDOS, ch = 'LDOS_fb',frame_width=300).opts(clim = (0.1E-9,1.5E-9)) # adjust cbar limit
...
hv_XY_slicing(grid_LDOS, ch = 'LDOS_fb',slicing= 'Y',frame_width=300).opts(clim=(0, 2.5E-9)) # check low intensity area
